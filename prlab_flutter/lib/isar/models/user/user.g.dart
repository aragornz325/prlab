...
int _userIsarEstimateSize(
  ...
  bytesCount += 3 + object.scopeNames.length * 3;
  {
    for (var i = 0; i < object.scopeNames.length; i++) {
      final value = object.scopeNames[i];
...
void _userIsarSerialize(
  ...
  writer.writeStringList(offsets[5], object.scopeNames);
...
UserIsar _userIsarDeserialize(
  ...
  object.scopeNames = reader.readStringList(offsets[5]) ?? [];
...
extension UserIsarQueryFilter
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition>
      scopeNamesLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
...
extension UserIsarQueryWhereDistinct
  ...
  QueryBuilder<UserIsar, UserIsar, QDistinct> distinctByBlocked() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'blocked');
    });
  }

  QueryBuilder<UserIsar, UserIsar, QDistinct> distinctByCreated() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QDistinct> distinctByScopeNames() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'scopeNames');
    });
  }
...
extension UserIsarQueryProperty
  ...
  QueryBuilder<UserIsar, bool, QQueryOperations> blockedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'blocked');
    });
  }

  QueryBuilder<UserIsar, DateTime?, QQueryOperations> createdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, List<String>, QQueryOperations> scopeNamesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'scopeNames');
    });
  }
