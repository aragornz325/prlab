...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i15.TipoDeOrganizacion) {
      return _i15.TipoDeOrganizacion.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i15.TipoDeOrganizacion?>()) {
      return (data != null
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i15.TipoDeOrganizacion) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'TipoDeOrganizacion') {
      return deserialize<_i15.TipoDeOrganizacion>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i15.TipoDeOrganizacion:
        return _i15.TipoDeOrganizacion.t;
    }
    return null;
  }
