...
import 'package:prlab_client/src/protocol/articulo.dart' as _i14;
import 'package:prlab_client/src/protocol/cliente.dart' as _i15;
import 'package:prlab_client/src/protocol/marca.dart' as _i16;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i1.getType<List<_i13.Cliente>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i13.Cliente>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i13.Articulo>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i13.Articulo>(e)).toList()
          : null) as dynamic;
    }
