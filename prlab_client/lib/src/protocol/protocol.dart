...
import 'error_pr_lab.dart' as _i6;
import 'imagen_articulo.dart' as _i7;
...
import 'package:prlab_client/src/protocol/articulo.dart' as _i15;
import 'package:prlab_client/src/protocol/cliente.dart' as _i16;
import 'package:prlab_client/src/protocol/marca.dart' as _i17;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.ImagenArticulo) {
      return _i7.ImagenArticulo.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i7.ImagenArticulo?>()) {
      return (data != null ? _i7.ImagenArticulo.fromJson(data, this) : null)
          as T;
    }
    ...
    if (t == _i1.getType<List<_i14.Articulo>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i14.Articulo>(e)).toList()
          : null) as dynamic;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'ImagenArticulo') {
      return deserialize<_i7.ImagenArticulo>(data['data']);
    }
